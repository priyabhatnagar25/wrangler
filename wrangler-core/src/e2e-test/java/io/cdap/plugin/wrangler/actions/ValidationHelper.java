...
public class ValidationHelper {
  ...
  private static String getIdKey(JsonObject json) {
    if (json.has("id")) {
      ...
      return "Customer_id";
    } else if (json.has("body_note_heading")) {
      return "body_note_heading";
    } else if (json.has("body_note_body")) {
      return "body_note_body";
    } else if (json.has("body_note_from")) {
      return "body_note_from";
    } else if (json.has("body_note_to")) {
      return "body_note_to";
